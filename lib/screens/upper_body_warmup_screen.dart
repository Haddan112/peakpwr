...
class UpperBodyWarmupScreen extends StatefulWidget {
  const UpperBodyWarmupScreen({super.key});
  @override
  State<UpperBodyWarmupScreen> createState() => _UpperBodyWarmupScreenState();
}

class _UpperBodyWarmupScreenState extends State<UpperBodyWarmupScreen> {
  late List<bool> _completed;
  final List<Map<String, String>> warmupExercises = const [
    {'title': 'Cycle Warmup', 'subtitle': '5 min', 'icon': '🚴'},
    {'title': 'Arm Circles', 'subtitle': '15 reps', 'icon': '🔄'},
    {'title': 'Band Shoulder Circles', 'subtitle': '15 reps', 'icon': '🔘'},
    {'title': 'Trunk Rotations (Alternating)', 'subtitle': '15 reps', 'icon': '🌀'},
    {'title': 'Bench Press Warm-up', 'subtitle': '8 reps × 2 sets', 'icon': '🏋️'},
  ];
